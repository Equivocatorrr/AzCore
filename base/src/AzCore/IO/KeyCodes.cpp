...
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xad,   // 0x78
0xaf,   0xae,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   // 0x80
...
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   // 0xd0
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   // 0xd8
0x11,   0x10,   0x12,   0x5b,   0xff,   0x10,   0xff,   0x5d,   // 0xe0
0xb3,   0xff,   0xb1,   0xb0,   0xff,   0xaf,   0xae,   0xad,   // 0xe8
0xff,   0xff,   0xff,   0xb2,   0xff,   0xff,   0xff,   0xff,   // 0xf0
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff    // 0xf8
};
...
0x1b,   0x1c,   0x1d,   0xe3,   0xff,   0xe7,   0xff,   0xff,   // 0x58
...
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   // 0x98
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   // 0xa0
0xff,   0xff,   0xff,   0xff,   0xff,   0x7f,   0x81,   0x80,   // 0xa8
0xeb,   0xea,   0xf3,   0xe8,   0xff,   0xff,   0xff,   0xff,   // 0xb0
...
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   // 0xd0
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   // 0xd8
0x1d,   0x2a,   0x38,   0x5b,   0x1d,   0x36,   0x38,   0x5d,   // 0xe0
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   // 0xe8
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   // 0xf0
0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff,   0xff    // 0xf8
};
...
0x05,   0x11,   0x10,   0x36,   0x37,   0x38,   0xe5,   0x46,   // 0x30
...
0x45,   0xff,   0xff,   0xe3,   0xff,   0xe7,   0xff,   0xff,   // 0x58
...
void PrintKeyCodeMaps(const u8* map, const char* name, const char* inverseName, Log& cout) {
	cout.PrintLn("\nconst u8 ", name, "[256] = {");
	for (u16 i = 0; i < 256; i++) {
		u32 toPrint = map[i];
		cout.Print("0x");
