...
#include "Memory.hpp"
#include "RAIIHacks.hpp"
#include "Template.hpp"

namespace AzCore {

template<typename Array_t>
using fp_lessThanGeneric_t = bool (*)(Array_t &, i64, i64);

template<typename Array_t, typename T=array_subscript_t<Array_t, i64>>
using fp_swapGeneric_t = void (*)(Array_t &, i64, i64, T &);

template<typename Array_t>
bool lessThanGeneric(Array_t &array, i64 indexLHS, i64 indexRHS) {
...
#define MAYBE_CONSTRUCT_TEMP(temp) \
	...
	struct alignas(alignof(_Temp_t)) FakeTemp_t { char bytes[sizeof(_Temp_t)]; };\
...
template<
	typename Array_t,
	typename LessThanFunc_t=fp_lessThanGeneric_t<Array_t>,
	typename SwapFunc_t=fp_swapGeneric_t<Array_t>,
	// Use SFINAE to coerce the overloads into behaving
	typename = std::enable_if_t<
		std::is_invocable_v<LessThanFunc_t, Array_t&, i64, i64>
		&& std::is_invocable_v<SwapFunc_t, Array_t&, i64, i64, az::array_subscript_t<Array_t, i64>&>
	>
>
...
template<
	...
	>
>
void QuickSort(Array_t &array, i64 indexStart, i64 indexEnd, const LessThanFunc_t &lessThan=lessThanGeneric<Array_t>, const SwapFunc_t &swap=swapGeneric<Array_t, false>, az::array_subscript_t<Array_t, i64> *temp=nullptr) {
	MAYBE_CONSTRUCT_TEMP(temp);
...
template<
	...
	>
>
inline void Sort(Array_t &array, i64 indexStart, i64 indexEnd, const LessThanFunc_t &lessThan=lessThanGeneric<Array_t>, const SwapFunc_t &swap=swapGeneric<Array_t, false>, az::array_subscript_t<Array_t, i64> *temp=nullptr) {
...
template<
	...
	>
>
inline void Sort(Array_t &array, const LessThanFunc_t &lessThan=lessThanGeneric<Array_t>, const SwapFunc_t &swap=swapGeneric<Array_t, false>, az::array_subscript_t<Array_t, i64> *temp=nullptr) {
	QuickSort(array, (i64)0, (i64)array.size, lessThan, swap, temp);
}
...
template<
	...
	>
>
inline void SortStable(Array_t &array, i64 indexStart, i64 indexEnd, const LessThanFunc_t &lessThan=lessThanGeneric<Array_t>, const SwapFunc_t &swap=swapGeneric<Array_t, false>, az::array_subscript_t<Array_t, i64> *temp=nullptr) {
	BubbleSort(array, indexStart, indexEnd, lessThan, swap, temp);
}
...
template<
	...
	>
>
inline void SortStable(Array_t &array, const LessThanFunc_t &lessThan=lessThanGeneric<Array_t>, const SwapFunc_t &swap=swapGeneric<Array_t, false>, az::array_subscript_t<Array_t, i64> *temp=nullptr) {
	BubbleSort(array, (i64)0, (i64)array.size, lessThan, swap, temp);
}
